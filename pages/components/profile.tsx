...
const Profile: FC<ProfileProps> = ({
  ...
  return (
    <>
      <div>
        <div className="transition duration-300 opacity-100 mb-24">
          <div className="flex items-center space-x-6 rounded-md ml-3">
            <div className="rounded-full bg-gradient-to-tl from-purple-700/60 to-rose-400/60 shadow-lg p-[3px] ring-[5px] ring-purple-500/10">
              <div className="rounded-full bg-gradient-to-tl from-purple-700/60 to-rose-400/60 shadow-lg p-[2px] ring-[5px] h-[64px] w-[64px] ring-purple-500/10 absolute animate-ping" />
          ...
          <div className="flex items-center justify-between">
            ...
            >
              <a
                ...
                href="/"
              >
                <div className="rounded-full bg-gradient-to-tl from-purple-700/60 to-rose-400/60 shadow-lg p-[2px] group transform transition ease-out hover:scale-105 hover:from-purple-700 hover:to-rose-400 hover:shadow-rose-500/25 active:translate-y-px">
